...
const en = {
  ...
  hint: {
    ...
    playlist: "Play a public YouTube list",
    oldSongs: "Memories",
...
const hi: Dictionary = {
  ...
  hint: {
    ...
    playlist: "अपनी पब्लिक YouTube लिस्ट चलाएं",
    oldSongs: "यादें",
...
const bho: Dictionary = {
  ...
  hint: {
    ...
    playlist: "पब्लिक YouTube लिस्ट बजाईं",
    oldSongs: "इयाद",
